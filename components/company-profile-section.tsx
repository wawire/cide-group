    ...
    <section className="py-20 bg-[#f4efec] border-y border-[#e6dcda]">
      <div className="section-shell">
        <div className="text-center mb-10">
          <p className="section-kicker mb-3">Mission, Vision and Values</p>
        ...
        <div className="grid lg:grid-cols-[1.4fr_1fr] gap-8">
          <Card className="p-8 bg-white border-[#e2d9d9]">
              <p className="section-kicker mb-4">Core Values</p>
              <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-3">
                {companyProfile.coreValues.map((value) => (
                  <div
                    key={value.title}
                    className="rounded-lg border border-[#e2d9d9] bg-[#faf7f5] px-4 py-3 text-sm font-semibold text-foreground"
                  >
                    {value.title}
                  </div>
                ))}
